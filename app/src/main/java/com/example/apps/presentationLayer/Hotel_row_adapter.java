...
public class Hotel_row_adapter
    ...
    @NonNull
    @Override
    public Hotel_row_Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(c).inflate(R.layout.hotel_row,parent,false);
        return new Hotel_row_Holder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Hotel_row_Holder holder, int position) {
